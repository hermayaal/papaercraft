...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/images/logo-fix-122x122.png" type="image/x-icon">
  <meta name="description" content="">
  <title>3D KIDS PAPERCRAFT</title>
...
<body>
  <section class="menu cid-s1TaRvr0zq" once="menu" id="menu1-0">
        ...
        <div class="navbar-brand">
          <span class="navbar-logo">
            <a href=<?php echo base_url("user/index"); ?>>
              <img src="<?php echo base_url(); ?>assets/images/logo-fix-122x122.png" alt="Mobirise" title="" style="height: 3.8rem;">
            </a>
          </span>
          <span class="navbar-caption-wrap">
            <a class="navbar-caption text-white display-4" href=<?php echo base_url("user/index"); ?>>
            3D KIDS PAPERCRAFT</a>
          </span>
        </div>
      </div>
    </nav>
